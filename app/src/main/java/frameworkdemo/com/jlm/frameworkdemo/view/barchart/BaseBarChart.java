...
public abstract class BaseBarChart extends BaseChart {
    ...
    public BaseBarChart(Context context) {
        ...
        mBarWidth = BarChartUtils.dpToPx(DEF_BAR_WIDTH);
        mBarMargin = BarChartUtils.dpToPx(DEF_BAR_MARGIN);
    ...
    public BaseBarChart(Context context, AttributeSet attrs) {
        ...
        try {
            ...
            mBarWidth = a.getDimension(R.styleable.BaseBarChart_egBarWidth, BarChartUtils.dpToPx(DEF_BAR_WIDTH));
            mBarMargin = a.getDimension(R.styleable.BaseBarChart_egBarMargin, BarChartUtils.dpToPx(DEF_BAR_MARGIN));
    ...
    protected void initializeGraph() {
        ...
        mMaxFontHeight = BarChartUtils.calculateMaxTextHeight(mLegendPaint, null);
            ...
            case MotionEvent.ACTION_DOWN:
                ...
                if (mListener == null) {
                    ...
                    for (RectF rectF : getBarBounds()) {
                        if (BarChartUtils.intersectsPointWithRectF(rectF, newX, newY)) {
