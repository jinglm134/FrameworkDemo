...
public abstract class BaseChart extends ViewGroup {
    ...
    protected BaseChart(Context context) {
        ...
        mLegendHeight = BarChartUtils.dpToPx(DEF_LEGEND_HEIGHT);
        mLegendTextSize = BarChartUtils.dpToPx(DEF_LEGEND_TEXT_SIZE);
    ...
    public BaseChart(Context context, AttributeSet attrs) {
        ...
        try {
            ...
            mLegendHeight = a.getDimension(R.styleable.BaseChart_egLegendHeight, BarChartUtils.dpToPx(DEF_LEGEND_HEIGHT));
            mLegendTextSize = a.getDimension(R.styleable.BaseChart_egLegendTextSize, BarChartUtils.dpToPx(DEF_LEGEND_TEXT_SIZE));
    ...
    public void setLegendHeight(float _legendHeight) {
        mLegendHeight = BarChartUtils.dpToPx(_legendHeight);
    ...
    public void setLegendTextSize(float _legendTextSize) {
        mLegendTextSize = BarChartUtils.dpToPx(_legendTextSize);
    }
    ...
    protected class Graph extends View {
        ...
        public void accelerate() {
            BarChartUtils.setLayerToHW(this);
        }
        ...
        public void decelerate() {
            BarChartUtils.setLayerToSW(this);
        }
    ...
    protected float mLegendTopPadding = BarChartUtils.dpToPx(0);
