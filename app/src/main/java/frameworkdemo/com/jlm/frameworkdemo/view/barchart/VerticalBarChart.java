...
public class VerticalBarChart extends BaseBarChart {
    ...
    protected void calculateBounds(float _Width, float _Margin) {
        ...
        mMaxFontHeight = BarChartUtils.calculateMaxTextHeight(mValuePaint, "190");
    }
    ...
    protected void drawBars(Canvas _Canvas) {
        ...
        for (BarModel model : mData) {
            ...
            valueString = BarChartUtils.getFloatString(model.getValue(), mShowDecimal) + mValueUnit;
    ...
    private int mValueDistance = (int) BarChartUtils.dpToPx(4);
}
