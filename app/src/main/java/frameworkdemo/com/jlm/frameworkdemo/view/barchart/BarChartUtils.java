...
import frameworkdemo.com.jlm.frameworkdemo.view.barchart.model.Point2D;
...
public class BarChartUtils {
    ...
    public static void calculateLegendInformation(List<? extends BaseModel> _Models, float _StartX, float _EndX, Paint _Paint) {
        float textMargin = BarChartUtils.dpToPx(10.f);
        float lastX = _StartX;
    ...
    private static final String LOG_TAG = BarChartUtils.class.getSimpleName();
}
